...
const ErrorState = ({ userError }: { userError: string | null }) => (
  <ProtectedRoute>
    <Layout title='Mi Cuenta'>
      <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6'>
...
// Helper component for user profile section
const UserProfileSection = ({ user }: { user: UserData }) => (
    ...
    <div className='space-y-4'>
      ...
      <div className='bg-gray-50 rounded-lg p-4 space-y-3'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
          ...
          <div>
            <span className='font-medium text-gray-600'>Imagen de Perfil:</span>
...
const MiCuentaPage = () => {
  ...
  if (userError || !user) {
    return <ErrorState userError={userError} />;
  }
